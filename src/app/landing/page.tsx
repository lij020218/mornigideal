        ...
        <div className="min-h-screen bg-[#FFFCF7] text-gray-900 overflow-x-hidden">
            ...
            <section className="relative pt-32 pb-24 px-6">
                ...
                >
                    ...
                    <motion.div variants={fadeUp} custom={3} className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-12">
                        <Link
                            href="/signup"
                            className="group flex items-center gap-2 bg-gradient-to-r from-amber-400 to-orange-400 text-white font-bold px-8 py-4 rounded-full text-lg hover:from-amber-500 hover:to-orange-500 transition shadow-lg shadow-amber-300/40"
                        >
                            무료로 시작하기
                            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </Link>
                        <p className="text-sm text-gray-400">카드 등록 없이 바로 시작</p>
                    </motion.div>
            ...
            <section className="py-24 px-6 bg-gradient-to-b from-amber-50/50 via-orange-50/30 to-transparent">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        {[
                            { step: "01", title: "가입하고 프로필 설정", desc: "직업, 관심사, 목표를 알려주세요. 1분이면 충분합니다.", color: "text-amber-300" },
            ...
            <section className="py-24 px-6">
                ...
                >
                    ...
                    <motion.div variants={fadeUp} custom={3}>
                        <Link
                            href="/signup"
                            className="group inline-flex items-center gap-2 bg-gradient-to-r from-amber-400 to-orange-400 text-white font-bold px-10 py-4 rounded-full text-lg hover:from-amber-500 hover:to-orange-500 transition shadow-lg shadow-amber-300/40"
                        >
                            무료로 시작하기
                            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </Link>
