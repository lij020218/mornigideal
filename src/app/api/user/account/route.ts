...
export const DELETE = withAuth(async (request: NextRequest, email: string) => {
    ...
    const deleteTasks: { table: string; filter: { column: string; value: string } }[] = [
        ...
        { table: "user_curriculum", filter: { column: "user_id", value: userId } },
        ...
        { table: "jarvis_notifications", filter: { column: "user_email", value: email } },
        { table: "learning_progress", filter: { column: "user_id", value: userId } },
        { table: "push_tokens", filter: { column: "user_email", value: email } },
        { table: "slack_tokens", filter: { column: "user_id", value: userId } },
        { table: "user_events", filter: { column: "email", value: email } },
        { table: "user_kv_store", filter: { column: "user_email", value: email } },
        { table: "trends_cache", filter: { column: "email", value: email } },
