...
1. **심층 분석**: 먼저 기사의 핵심 내용을 2-3문장으로 명확하게 요약한 뒤, 이 뉴스의 배경과 맥락을 설명하세요. "왜 이런 일이 일어났는지", "역사적 맥락에서 어떤 의미인지", "앞으로 어떤 변화가 예상되는지" 전문가 수준으로 분석. 경력 수준(${userLevel})에 맞는 전문 용어와 깊이로 설명하세요. 관련 데이터나 수치가 있으면 포함하세요.
...
1. **심층 분석**: 먼저 기사의 핵심 내용을 2-3문장으로 명확하게 요약한 뒤, 이 뉴스의 배경과 맥락을 분석하세요. "왜 이런 일이 일어났는지", "앞으로 어떤 변화가 예상되는지" 깊이 있게 설명.
...
1. **심층 분석**: 먼저 기사의 핵심 내용을 2-3문장으로 명확하게 요약한 뒤, 이 뉴스의 배경과 맥락을 설명하세요. "왜 이런 일이 일어났는지", "역사적 맥락에서 어떤 의미인지", "앞으로 어떤 변화가 예상되는지" 전문가 수준으로 분석. 경력 수준(${postUserLevel})에 맞는 전문 용어와 깊이로 설명하세요. 관련 데이터나 수치가 있으면 포함하세요.
2. **산업 파급 효과**: 이 뉴스가 관련 산업 생태계에 미치는 연쇄적 영향. 경쟁사 동향, 시장 구조 변화, 공급망 영향 등 거시적 관점에서 분석. 가능하면 구체적 기업이나 사례를 언급하세요.
