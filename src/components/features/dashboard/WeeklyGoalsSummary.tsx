...
export function WeeklyGoalsSummary() {
    ...
    if (loading) {
        return (
            <div className="bg-gradient-to-br from-white/5 to-white/[0.02] rounded-2xl p-6">
    ...
    return (
        <div className="bg-gradient-to-br from-white/5 to-white/[0.02] rounded-2xl overflow-hidden">
            {/* Header */}
            <div className="px-5 py-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-primary/20 to-purple-500/20 flex items-center justify-center">
                        <Flag className="w-4.5 h-4.5 text-primary" />
                    </div>
                    <div>
                        <h3 className="font-bold text-base">이번 주 목표</h3>
                        {totalCount > 0 && (
                ...
                <Link href="/growth">
                    <Button variant="ghost" size="sm" className="h-8 text-xs gap-1 text-muted-foreground hover:text-foreground hover:bg-white/5">
                        전체 보기
            ...
            <div className="px-5 pb-5">
                {totalCount === 0 ? (
                    <div className="text-center py-8 bg-white/[0.02] rounded-xl">
                        ...
                        <Link href="/growth">
                            <Button size="sm" className="rounded-xl gap-2 bg-primary/10 hover:bg-primary/20 text-primary">
                    ...
                    <div className="space-y-4">
                        ...
                        {weeklyGoals.length > 3 && (
                            <Link href="/growth" className="block">
                                <div className="text-center py-2 text-xs text-muted-foreground hover:text-foreground transition-colors">
