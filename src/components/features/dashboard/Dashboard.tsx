        ...
        const fetchAchievements = async () => {
            ...
            if (cached) {
                try {
                    ...
                    const twoHoursInMs = 2 * 60 * 60 * 1000; // Changed from 6 hours to 2 hours
