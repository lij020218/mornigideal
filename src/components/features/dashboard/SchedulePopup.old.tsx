...
const SCHEDULE_TEMPLATES = [
    {
        id: 'office-worker',
        name: '직장인',
        description: '평일 9-6 근무',
        schedule: { wakeUp: '07:00', workStart: '09:00', workEnd: '18:00', sleep: '23:00' },
        weekdayGoals: [
            { text: '출근 준비', startTime: '07:30', endTime: '08:30', color: 'purple', activity: 'breakfast' },
            { text: '점심 식사', startTime: '12:00', endTime: '13:00', color: 'amber', activity: 'lunch' },
        ],
        weekendGoals: [
            { text: '운동', startTime: '10:00', endTime: '11:30', color: 'pink', activity: 'exercise' },
        ]
    },
    {
        id: 'student',
        name: '학생',
        description: '오전 수업',
        schedule: { wakeUp: '06:30', workStart: '09:00', workEnd: '15:00', sleep: '23:30' },
        weekdayGoals: [
            { text: '등교 준비', startTime: '07:00', endTime: '08:00', color: 'purple', activity: 'breakfast' },
            { text: '자기계발', startTime: '19:00', endTime: '21:00', color: 'indigo', activity: 'study' },
        ],
        weekendGoals: []
    },
    {
        ...
        name: '자유',
        description: '기본 설정만',
        schedule: { wakeUp: '08:00', workStart: '10:00', workEnd: '18:00', sleep: '00:00' },
        weekdayGoals: [],
        weekendGoals: []
    }
];
